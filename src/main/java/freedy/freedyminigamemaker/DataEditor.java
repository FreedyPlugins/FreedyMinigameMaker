...
public class DataEditor
{
    ...
    public void create(final int maxPlayers, final int maxStartPlayers, final int waitForStartTime) {
        ...
        final List<String> gameList = this.plugin.getConfig().getStringList("gameList");
        if (!gameList.contains(this.gameName)) {
    ...
    public void setLocation(final String locationPath, final String world, final double x, final double y, final double z, final float yaw, final float pitch) {
        MiniGames.getLocations().getConfig().set(this.gamePath + locationPath + ".world", world);
        MiniGames.getLocations().getConfig().set(this.gamePath + locationPath + ".x", x);
        MiniGames.getLocations().getConfig().set(this.gamePath + locationPath + ".y", y);
        MiniGames.getLocations().getConfig().set(this.gamePath + locationPath + ".z", z);
        MiniGames.getLocations().getConfig().set(this.gamePath + locationPath + ".yaw", yaw);
        MiniGames.getLocations().getConfig().set(this.gamePath + locationPath + ".pitch", pitch);
        MiniGames.getLocations().saveConfig();
    }
